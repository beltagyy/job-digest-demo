...
const written = fs.readFileSync('app/page.tsx', 'utf8');
console.log('Lines written:', written.split('\\n').length);
console.log('Has Navigation:', written.includes('function Navigation'));
console.log('Has JobCard:', written.includes('function JobCard'));
console.log('Has PricingCard:', written.includes('function PricingCard'));
